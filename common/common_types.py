...
class ZmqCommand:
    def __init__(self, command_id, command_name):
        self.command_id = command_id
        self.command_name = command_name

    def pack(self):
        return self.command_id.to_bytes(4, "big")

    @staticmethod
    def unpack(command_bytes):
        return int.from_bytes(command_bytes,"big")


class ZmqResponse:
    def __init__(self, response_id, response_name):
        self.response_id = response_id
        self.response_name = response_name

    def pack(self):
        return self.response_id.to_bytes(4, "big")

    @staticmethod
    def unpack(response_bytes):
